...
6. Save the final selected output as a PNG under the job output directory provided by Codex-Canvas.
7. Codex-Canvas will collect the output and place it in a row to the right of the source image.
